...
public class CalculatorDivDoubleTest extends PreAndPostConditions {
    ...
    public void testDivision3() {
        Assert.assertTrue(Double.isInfinite(calculator.divDouble(1, 10E-310)), "неверное частное");
    }
    ...
    public void testDivision5() {
        Assert.assertTrue(Double.isInfinite(calculator.divDouble(1.7e308, 0.1)), "неверное частное");
    }
    ...
    public void testDivisionByZero() {
        Assert.assertTrue(Double.isInfinite(calculator.divDouble(1, 0)), "неверное частное");
    }
