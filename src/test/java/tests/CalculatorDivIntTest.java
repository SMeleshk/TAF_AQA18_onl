...
public class CalculatorDivIntTest extends PreAndPostConditions {
    ...
    public void testDivision(){
        Assert.assertEquals(calculator.division(6, 3), 2, "неверное частное");
    }
    ...
    public void testDivision3() {
        Assert.assertEquals(calculator.division(3, 6), 0, "неверное частное");
    }
    ...
    public void testDivision7() {
        Assert.assertEquals(calculator.division(-6, -1), 6, "неверное частное");
    }
    ...
    public void testDivision8() {
        Assert.assertEquals(calculator.division(-2147483648, 2147483647), -1, "неверное частное");
    }

    @Test (testName = "max and min", timeOut = 100)
    public void testDivision9() {
        Assert.assertEquals(calculator.division(2147483647, -2147483648), 0, "неверное частное");
    }
