...
public class WaitsTest extends BaseTest {
    ...
    //@Test
    public void explicitlyVisibilityTest() {
        ...
        button.click();
        Assert.assertTrue(waitsService.waitForInvisibilityOf(button));

        WebElement loading = waitsService.waitForVisibilityBy(By.id("loading"));
        Assert.assertTrue(loading.isDisplayed());
        Assert.assertTrue(waitsService.waitForInvisibilityOf(loading));
