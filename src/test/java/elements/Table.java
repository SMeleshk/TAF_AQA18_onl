...
public class Table {
    ...
    /**
     * Данный элемент идентифицируется по тегу table обязательно
     * @param driver
     * @param by
     */
    ...
    public UIElement getCell(String targetColumnName, String targetValue, String columnName) {
        //ищем по targetColumnName колонке строку с targetValue и в этой строоке находим элемент с columnName
        return null;
    }
